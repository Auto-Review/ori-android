...
import com.dd2d.domain.code_post.model.comment.CodePostComment
...
interface CodePostCommentRepository {
    fun getCodePostCommentList(option: CodePostCommentListOption): Flow<DataState<Pagination<CodePostComment>>>
    fun getCodePostCommentReplyList(option: CodePostCommentReplyListOption): Flow<DataState<Pagination<CodePostComment>>>
