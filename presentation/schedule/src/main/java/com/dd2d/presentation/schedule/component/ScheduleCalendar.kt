  ...
  LaunchedEffect(calendarState) {
    snapshotFlow { calendarState.layoutInfo.visibleMonthsInfo }
      .collect { visibleMonths ->
        ...
        val betweenStartAndLeft =
          ChronoUnit.MONTHS.between(calendarState.startMonth, leftMonth).absoluteValue
        ...
        val betweenEndAndRight =
          ChronoUnit.MONTHS.between(rightMonth, calendarState.endMonth).absoluteValue
