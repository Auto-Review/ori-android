...
import com.dd2d.data_source.remote.server.code_post.dto.response.CodePostCommentReplyListItemResponseDto
...
class CodePostCommentApi @Inject constructor(
    ...
    suspend fun getCodePostCommentReplyList(
        page: Int,
        size: Int,
    ): PagingResponseDto<CodePostCommentReplyListItemResponseDto> = client
