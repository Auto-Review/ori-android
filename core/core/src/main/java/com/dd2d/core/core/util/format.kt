...
fun LocalDateTime.setTimeToMin(): LocalDateTime =
  this.withHour(0).withMinute(0).withSecond(0).withNano(0)

/** 현재 날짜에서 `23시 59분 59초 999,999,999나노초`로 설정된 [LocalDateTime]을 반환합니다.*/
fun LocalDateTime.setTimeToMax(): LocalDateTime =
  this.withHour(23).withMinute(59).withSecond(59).withNano(999_999_999)
...
fun String.dateStringToLocalDate(pattern: String = "yyyy-MM-dd HH:mm:ss"): LocalDate =
  LocalDate.parse(this, DateTimeFormatter.ofPattern(pattern))

fun String.dateStringToLocalDateTime(pattern: String = "yyyy-MM-dd HH:mm:ss"): LocalDateTime =
  LocalDateTime.parse(this, DateTimeFormatter.ofPattern(pattern))

fun String.utcToLocalDateTime(): LocalDateTime =
  LocalDateTime.parse(this, DateTimeFormatter.ISO_DATE_TIME)

fun String.utcToLocalDate(): LocalDate =
